        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        @if($profile->photo)
                            <img src="{{url('/Carjeep/public/../storage/app/'.$profile->photo)}}" class="img-fluid" style="border-radius:50%;height:80px;width:80px;margin:auto;" alt="User Avatar">
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('vendor-profile-update',$profile->id)}}" enctype="multipart/form-data">
                    @csrf
